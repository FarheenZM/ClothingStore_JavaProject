...
public class Runner {
    ...
    Product clothing1 = new Product("Wide Leg Trousers", "Checked wool and mohair-blend wide-leg pants", Category.CLOTHES, 275, "/public.public/ClothingImages/checked_pants.jpg", ClothesShop);
		DBHelper.save(clothing1);
    Product shoe1 = new Product("Lace Stilettos", "Portofino 105 lace sandals", Category.SHOES, 175, "/public.public/ClothingImages/Heels.jpg", ClothesShop);
		DBHelper.save(shoe1);
    Product accessory1 = new Product("Embroidered cotton-twill baseball cap", " Made from black cotton-twill, this version is embroidered with 'Femme' on the front and has a Velcro®-fastening strap at the back. Style yours with one of the label's denim jackets.", Category.ACCESSORIES, 50, "/public.public/ClothingImages/Cap.jpg", ClothesShop );
		DBHelper.save(accessory1);
    Product newin1 = new Product("Wallace denim midi dress", "This belted 'Wallace' midi dress is cut from denim woven with a touch of stretch and traced with oversized gold buttons. Layer it over a turtleneck or T-shirt when the weather cools.", Category.NEW_IN, 300,"/public.public/ClothingImages/Denim_dress.jpg", ClothesShop );
